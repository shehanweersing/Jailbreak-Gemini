...
DARK GEMINI
Note:  This prompt will not work in the regular Gemini window - you’ll need to open Google AI studio, select “Gemini 1.5 Pro” and set the safety settings to the lowest filtering option!
